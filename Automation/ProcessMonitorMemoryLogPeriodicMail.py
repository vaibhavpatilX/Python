...
def ProcessLog(log_dir = 'MarvellousX'):
    listprocess = []
    ...
    f = open(log_path, 'w')
    f.write(separator + "\n")
    f.write("Marvellous_Infosystems_Process_Logger"+time.ctime() + "\n")
    f.write(separator + "\n")
    f.write("\n")
